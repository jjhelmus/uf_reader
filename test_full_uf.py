...
radar = uf.read_uf('sample_files/sample_uf.uf')
ref_radar = pyart.io.read_rsl('sample_files/sample_uf.uf',
...
def check_field(field):
    ...
    # the RH_INVF function in RSL does not differential between 0 and BADVAL
    if field == 'RH':
        mask2[radar.fields[field]['data'] == 0] = True
